    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(user == null)
                {
                    AddModelErrorMessage("Ehhez az email címhez nem található regisztráció");
                    return Page();
                }
                ...
                {
                    AddModelErrorMessage("Sikertelen bejelentkezési kísérlet. Elképzelhető, hogy a felhasználói fiókja még nincs aktiválva.");
                    return Page();
                }
            }
        ...
        private void AddModelErrorMessage(string errorMessage)
        {
            ModelState.AddModelError(string.Empty, errorMessage);
        }
    }
