...
namespace CaseHandler.WebApplication.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(maximumLength: 50, ErrorMessage = "A {0} hosszának {2} és {1} karakter között kell lennie.", MinimumLength = 5)]
            [Required(ErrorMessage = "Az {0} megadása kötelező")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = Input.UserName, Email = Input.Email, IsAdmin = false };
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Sikeres regisztráció - Email cím megerősítése",
                        $"Kérjük, erősítse meg az email címét az alábbi <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>linkre</a> kattintva.");
